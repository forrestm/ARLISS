...
PWMB = 'Y10'      # PWMB pin on board, controls the speed of Motor B (must be this pin to be on same timer and channel as PWMA)

# motorA must be the left wheel
...
#Move both wheels in opposite directions at same speed to rotate
